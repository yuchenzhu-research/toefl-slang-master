...
# 提取 PDF 文本
python .claude/skills/content-parser/pdf_helper.py <pdf文件路径>

# 输出笔记模板
python .claude/skills/content-parser/pdf_helper.py <pdf文件路径> --template
```
...
这样用户可以直接复制到项目的 `.claude/notes/` 目录长期存储。